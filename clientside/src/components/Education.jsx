...
const Details = ({education, time, title , info }) => {
    return <li className='my-10 first:mt-1 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[100%] '>
        <div>
            ...
            <p className='w-full text-black font-medium sm:text-md'>
                {info}
            </p>
        </div>
    </li>
  ...
  return (
    <div className='my-32'>
      <div ref={ref} className='w-[75%] mx-auto relative'>
        ...
        <motion.div style={{scaleY: scrollYProgress}} className='absolute left-8 top-2 w-[2px] h-full bg-black origin-top md:left-0 '/>
        ...
        <ul className='w-full flex flex-col items-start justify-between ml-4'>
          ...
          time="August 2019 - June 2023" title ="ITM University, Gwalior"
          ...
          time="June 2017 - May 2018" title ="Sri Chaitanya Junior College"
          ...
          time="May 2015 - March 2016" title ="Sri Chaitanya School"
